...
- (void)setUpButtons:(NSUInteger)count withImages:(NSArray *)images backgroundImage:(UIImage *)bImage radius:(CGFloat)buttonRadius{
    ...
    switch (count) {
        case 3:
        {
            ...
            button_0.frame = CGRectMake(kDCPathButtonAllTypeTag_0_startPosition_x, kDCPathButtonAllTypeTag_0_startPosition_y, buttonRadius*2, buttonRadius*2);
            button_1.frame = CGRectMake(kDCPathButtonAllTypeTag_1_startPosition_x, kDCPathButtonAllTypeTag_1_startPosition_y, buttonRadius*2, buttonRadius*2);
            ...
            case 4:
            {
                [self expandButtonAtType_1:button_2
                               fromStart_x:kDCPathButtonType_2_Tag_2_startPosition_x
                                ...
                                withRadius:kCurrentButtonRadius];
                [self expandButtonAtType_1:button_3
...
- (void)expandButtonAtType_1:(UIButton *)button fromStart_x:(CGFloat)startPoint_x andStart_y:(CGFloat)startPoint_y toEnd_x:(CGFloat)endPoint_x andEnd_y:(CGFloat)endPoint_y withRadius:(CGFloat)currentButtonRadius{
    ...
    button_rotation.values = [NSArray arrayWithObjects:[NSNumber numberWithFloat:0.0f], [NSNumber numberWithFloat:(button.tag%2) == 0? kDCPathButtonDefaultRotation:kDCPathButtonDefaultReverseRotation], [NSNumber numberWithFloat:0.0f], nil];
